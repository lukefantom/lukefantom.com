export default function StripeIcon({ className }) {
  return (
    <svg className={className} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 468 222.5" style={{ enableBackground: "new 0 0 468 222.5", fill: "#2e465cde", width: "3rem", margin: "0" }} xmlSpace="preserve">
      <g>
        <path
          class="st0"
