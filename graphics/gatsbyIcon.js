export default function GatsbyIcon({ className }) {
  return (
    <svg className={className} version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 28 28" style={{ enableBackground: "new 0 0 28 28", fill: "#2e465cde" }} xmlSpace="preserve">
      <g>
        <path
